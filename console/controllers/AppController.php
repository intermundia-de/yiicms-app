...
class AppController extends Controller
{
    ...
    public function actionSetup()
    {
        ...
        \Yii::$app->runAction('migrate/up', [
            ...
            'migrationPath' => '@vendor/apollo11/yii2-logger/migrations'
        ]);
        \Yii::$app->runAction('migrate/up', [
            'interactive' => $this->interactive,
        ...
        \Yii::$app->runAction('rbac-migrate/up', ['interactive' => $this->interactive]);
        \Yii::$app->runAction('sync/languages', ['interactive' => $this->interactive]);
        \Yii::$app->runAction('sync/websites', ['interactive' => $this->interactive]);
    }
